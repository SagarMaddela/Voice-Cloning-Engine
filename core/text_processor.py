"""
Text Processor for Voice Cloning Engine.

This module handles text preprocessing and chunking for optimal
TTS generation, preserving sentence and punctuation structure.
"""
import re
...
def split_text_into_chunks(text, max_length=MAX_CHUNK_LENGTH):
    ...
    - Maintaining punctuation
    - Handling long sentences by splitting on commas
    - Splitting very long parts by words
    
    Args:
        text: Input text to split
        max_length: Maximum length per chunk (default from config)
